...
// Forward-Declare hex::core::ILogger
#ifndef HEX_CORE_I_LOGGER_DECL
    #define HEX_CORE_I_LOGGER_DECL
    namespace hex { namespace core { class ILogger; } }
#endif /// !HEX_CORE_I_LOGGER_DECL
...
namespace hex
{
    ...
    namespace core
    {
        ...
        private:
            ...
            using logger_ptr = ILogger*;

            // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
            // FIELDS
            // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

            static logger_ptr mLogger;
