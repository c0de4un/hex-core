...
#define HEX_CORE_BATCHING_REQUEST_HPP
...
// Include hex::core::IBatchable
#ifndef HEX_CORE_I_BATCHABLE_HXX
    #include <hex/core/render/IBatchable.hxx>
...
namespace hex
{
    ...
    namespace core
    {
        ...
        HEX_API struct BatchingRequest
        {
            ...
            hexShared<hexIBatchable> mpBatchableObject;
...
using hexBatchingRequest = hex::core::BatchingRequest;
