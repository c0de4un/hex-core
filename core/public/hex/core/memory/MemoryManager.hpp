...
// Include hex::core::RefenreceBlock
#ifndef HEX_CORE_REFERENCE_BLOCK
    #include <hex/core/memory/ReferenceBlock.hpp>
...
namespace hex
{
    ...
    namespace core
    {
        ...
        private:
            ...
            mutable hexMutex                 mReferencesCountersMutex;
            hexMap< void*, ReferenceBlock* > mReferencesBlocks;
            ...
            inline ReferenceBlock* getNextReferenceBlock(hexMap<void*, ReferenceBlock*>::iterator& iter) noexcept;
            inline ReferenceBlock* getReferenceBlock(void* pAddress, const bool allocate);

            // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
            // METHODS
            // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

            inline void deleteObjects() noexcept;
        ...
        public:
            ...
            static MemoryManager* const getInstance() noexcept;

            size_t getReferenceCount(void* pAddress) const HEX_NOEXCEPT;
            ...
            void addReferenceUser(void* const pAddress, IReferenceUser* pUser) HEX_NOEXCEPT;
            void removeReferenceUser(void* const pAddress, IReferenceUser* pUser) HEX_NOEXCEPT;
