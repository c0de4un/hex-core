...
// Include hex::core::IShader
#ifndef HEX_CORE_I_SHADER_HXX
    #include <hex/core/assets/IShader.hxx>
...
namespace hex
{
    ...
    namespace core
    {
        ...
        HEX_API class Shader : public hexAsset, hexIShader
        {
        ...
        public:
            ...
            const hexString* const mSourceFile;
            const hexString* const mSourceCode;
