...
namespace hex
{
    ...
    namespace core
    {
        ...
        private:
            ...
            // @see Intel's SpinLock implementation
            static constexpr const unsigned char MAX_SPINS = 44;
            ...
            inline void handleSpin() const noexcept;
        ...
        public:
            ...
            explicit SpinLock(hexMutex& lock, const bool defer = false);
...
using hexLock = hex::core::SpinLock;
