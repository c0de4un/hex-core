...
// Include hex::core::GraphicsSettings
    ...
    #include <hex/core/graphics/GraphicsSettings.hpp>
...
namespace hex
{
    ...
    namespace core
    {
        ...
        public:
            ...
            virtual ~IGraphics() noexcept = default;

            // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
            // GETTERS & SETTERS
            // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

            virtual hexShared<hexGraphicsSettings> getSettings()               = 0;
            virtual void setSettings(hexShared<hexGraphicsSettings> pSettings) = 0;
...
using hexIGraphics = hex::core::IGraphics;
